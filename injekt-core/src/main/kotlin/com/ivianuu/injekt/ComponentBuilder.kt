...
class ComponentBuilder {
    ...
    var jitFactories = emptyList<(Key<Any?>, Component) -> BindingProvider<Any?>?>()
        private set
     ...
     */
    fun jitFactory(factory: (Key<Any?>, Component) -> BindingProvider<Any?>?) {
        jitFactories(factory)
    }

    fun jitFactories(vararg factories: (Key<Any?>, Component) -> BindingProvider<Any?>?) {
     ...
     */
    fun setJitFactories(factories: List<(Key<Any?>, Component) -> BindingProvider<Any?>?>) {
     ...
     * Removes the [factory]
     */
    fun removeJitFactory(factory: (Key<Any?>, Component) -> BindingProvider<Any?>?) {
