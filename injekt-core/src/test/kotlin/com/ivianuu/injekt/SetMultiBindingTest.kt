...
class SetMultiBindingTest {
    ...
    fun testNestedOverride() {
        ...
        val componentB = Component {
            parents(componentA)
            com.ivianuu.injekt.set<Command> { add<Command>(duplicateStrategy = DuplicateStrategy.Override) { Command2 } }
        }
    ...
    fun testNestedOverrideDrop() {
        ...
        val componentB = Component {
            parents(componentA)
            com.ivianuu.injekt.set<Command> { add<Command>(duplicateStrategy = DuplicateStrategy.Drop) { Command2 } }
        }
