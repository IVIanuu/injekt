...
class ImplicitTest {
    ...
    fun testSimpleReader() = codegen(
        ...
        fun invoke(): Foo { 
            return rootContext().runReader { func() }
        }
    """
    ) {
    ...
    fun testReaderCallInDefaultParameter() = codegen(
        ...
        fun invoke(): Foo { 
            return rootContext().runReader { withDefault() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun multiCompileReader() = multiCodegen(
        ...
        listOf(
            source(
                """ 
                fun getFoo() = rootContext().runReader {
                    withBar {
                        foo()
                    }
                }
    ...
    fun testReaderProperty() = codegen(
        ...
        fun invoke(): Foo { 
            return rootContext().runReader { foo }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testFunctionReturnsReaderLambda() = codegen(
        ...
        fun invoke(): Foo { 
            return rootContext().runReader { getFooProvider()() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testSimpleConditionalLambda() = codegen(
        """
            ...
            fun invoke(clazz: KClass<*>): Any {
                ...
                return rootContext().runReader { provider() }
            }
        """
    ) {
    ...
    fun testReaderClass() = codegen(
        ...
        fun invoke(): Foo { 
            return rootContext().runReader { FooFactory().getFoo() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testInjectReaderClass() = codegen(
        ...
        fun invoke(): Foo { 
            return rootContext().runReader { given<FooFactory>().getFoo() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testReaderClassAccessesReaderFunctionInInit() = codegen(
        ...
        fun invoke(): Foo {
            return rootContext().runReader { given<FooFactory>().foo }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testGenericReader() = codegen(
        ...
        fun invoke(): Foo { 
            return rootContext().runReader { provide() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testGivenInDefaultParameter() = codegen(
        ...
        fun invoke(): Foo { 
            return rootContext().runReader { createFoo() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testGenericReaderDependencyOfSameType() = codegen(
        ...
        fun invoke() { 
            rootContext().runReader { given<MyClass>() }
        }
    """
    ) {
        invokeSingleFile()
    ...
    fun testGivenCallInComplexDefaultExpressionCreatesAnAdditionalValueParameter() = codegen(
        ...
        fun invoke() {
            rootContext().runReader { createFoo(Foo()) }
        }
    """
    ) {
    ...
    fun testReaderFunctionRef(): Unit = codegen(
        ...
        fun invoke(): Foo { 
            ...
            return rootContext().runReader { funcRef() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testRunReaderBlockFunctionRef(): Unit = codegen(
        ...
        fun invoke(): Foo {
            return rootContext().runReader(block = ::runReaderBlock)
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
