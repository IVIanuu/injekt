...
class ImplicitTest {
    ...
    fun testSimpleReader() = codegen(
        ...
        fun invoke(): Foo { 
            return context<TestComponent>().runReader { func() }
        }
    """
    ) {
    ...
    fun testSimpleReaderLambda() = codegen(
        ...
        fun invoke(): Foo {
            return context<TestComponent>().runReader {
                withFoo {
                    other()
                    it
                }
    ...
    fun testReaderCallInDefaultParameter() = codegen(
        ...
        fun invoke(): Foo { 
            return context<TestComponent>().runReader { withDefault() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun multiCompileReader() = multiCodegen(
        ...
        listOf(
            source(
                """ 
                fun getFoo() = context<TestComponent>().runReader {
                    withBar {
                        foo()
                    }
                }
    ...
    fun testReaderProperty() = codegen(
        ...
        fun invoke(): Foo { 
            return context<TestComponent>().runReader { foo }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testFunctionReturnsReaderLambda() = codegen(
        ...
        fun invoke(): Foo { 
            return context<TestComponent>().runReader { getFooProvider()() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testSimpleConditionalLambda() = codegen(
        """
            ...
            fun invoke(clazz: KClass<*>): Any {
                ...
                return context<TestComponent>().runReader { provider() }
            }
        """
    ) {
    ...
    fun testReaderClass() = codegen(
        ...
        fun invoke(): Foo { 
            return context<TestComponent>().runReader { FooFactory().getFoo() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testInjectReaderClass() = codegen(
        ...
        fun invoke(): Foo { 
            return context<TestComponent>().runReader { given<FooFactory>().getFoo() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testReaderClassAccessesReaderFunctionInInit() = codegen(
        ...
        fun invoke(): Foo {
            return context<TestComponent>().runReader { given<FooFactory>().foo }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testGenericReader() = codegen(
        ...
        fun invoke(): Foo { 
            return context<TestComponent>().runReader { provide() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testGivenInDefaultParameter() = codegen(
        ...
        fun invoke(): Foo { 
            return context<TestComponent>().runReader { createFoo() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testGenericReaderDependencyOfSameType() = codegen(
        ...
        fun invoke() { 
            context<TestComponent>().runReader { given<MyClass>() }
        }
    """
    ) {
        invokeSingleFile()
    ...
    fun testGivenCallInComplexDefaultExpressionCreatesAnAdditionalValueParameter() = codegen(
        ...
        fun invoke() {
            context<TestComponent>().runReader { createFoo(Foo()) }
        }
    """
    ) {
    ...
    fun testReaderFunctionRef(): Unit = codegen(
        ...
        fun invoke(): Foo { 
            ...
            return context<TestComponent>().runReader { funcRef() }
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
    ...
    fun testRunReaderBlockFunctionRef(): Unit = codegen(
        ...
        fun invoke(): Foo {
            return context<TestComponent>().runReader(block = ::runReaderBlock)
        }
    """
    ) {
        assertTrue(invokeSingleFile() is Foo)
