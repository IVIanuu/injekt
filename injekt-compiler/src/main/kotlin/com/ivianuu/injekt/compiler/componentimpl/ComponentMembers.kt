package com.ivianuu.injekt.compiler.componentimpl

import com.ivianuu.injekt.Assisted
import com.ivianuu.injekt.Binding
import com.ivianuu.injekt.compiler.Callable
import com.ivianuu.injekt.compiler.ClassifierRef
import com.ivianuu.injekt.compiler.CodeBuilder
import com.ivianuu.injekt.compiler.SimpleTypeRef
import com.ivianuu.injekt.compiler.TypeRef
import com.ivianuu.injekt.compiler.child
import com.ivianuu.injekt.compiler.renderExpanded
        ...
        val finalExpression = if (binding.targetComponent == null ||
        ...
        ) rawExpression else (
            {
                val property = ComponentCallable(
                    name = "_${binding.type.uniqueTypeName()}",
                    type = SimpleTypeRef(ClassifierRef("kotlin.Any"), isMarkedNullable = true),
