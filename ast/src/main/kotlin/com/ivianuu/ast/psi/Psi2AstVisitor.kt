...
import com.ivianuu.ast.tree.declaration.AstDeclarationBase
import com.ivianuu.ast.tree.declaration.AstDeclarationParent
...
class Psi2AstVisitor(
        ...
        return file.cached(
            context.storage.files,
            {
                AstFile(
                    ...
                    name = Name.identifier(file.name)
                )
            }
        ) {
    ...
    override fun visitLambdaExpression(expression: KtLambdaExpression, mode: Mode): AstElement {
