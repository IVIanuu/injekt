...
import com.ivianuu.ast.utils.Protected
import com.ivianuu.ast.utils.TypeRegistry
import com.ivianuu.ast.utils.isEmpty
...
class ConeAttributes private constructor(attributes: List<ConeAttribute<*>>) :
    AttributeArrayOwner<ConeAttribute<*>, ConeAttribute<*>>() {
    ...
    private inline fun perform(
        other: ConeAttributes,
        op: ConeAttribute<*>.(ConeAttribute<*>?) -> ConeAttribute<*>?
    ): ConeAttributes {
