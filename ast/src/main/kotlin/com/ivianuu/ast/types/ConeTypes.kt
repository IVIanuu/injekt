...
import com.ivianuu.ast.types.ConeNullability
...
data class ConeKotlinTypeProjectionIn(override val type: ConeKotlinType) :
    ConeKotlinTypeProjection() {
    override val kind: ProjectionKind
        get() = ProjectionKind.IN
}

data class ConeKotlinTypeProjectionOut(override val type: ConeKotlinType) :
    ConeKotlinTypeProjection() {
    override val kind: ProjectionKind
...
open class ConeFlexibleType(
    ...
    override val nullability: ConeNullability
        get() = lowerBound.nullability.takeIf { it == upperBound.nullability }
...
data class ConeDefinitelyNotNullType(val original: ConeKotlinType) : ConeSimpleKotlinType(),
...
class ConeRawType(lowerBound: ConeKotlinType, upperBound: ConeKotlinType) :
...
class ConeStubType(val variable: ConeTypeVariable, override val nullability: ConeNullability) :
    StubTypeMarker, ConeSimpleKotlinType() {
    override val typeArguments: Array<out ConeTypeProjection>
        get() = emptyArray()
...
class ConeTypeVariableTypeConstructor(val debugName: String) : ConeClassifierLookupTag(),
