...
abstract class AstPropertyAccessor : AstPureAbstractElement(), AstFunction<AstPropertyAccessor>, AstTypeParametersOwner {
    ...
    abstract override fun <D> transformReturnTypeRef(transformer: AstTransformer<D>, data: D): AstPropertyAccessor

    abstract override fun <D> transformReceiverTypeRef(transformer: AstTransformer<D>, data: D): AstPropertyAccessor
