...
abstract class AstAnonymousFunction : AstFunction<AstAnonymousFunction>, AstExpression(), AstTypeParametersOwner {
    ...
    abstract override fun <D> transformReturnTypeRef(transformer: AstTransformer<D>, data: D): AstAnonymousFunction

    abstract override fun <D> transformReceiverTypeRef(transformer: AstTransformer<D>, data: D): AstAnonymousFunction
