...
internal class AstComposedSuperTypeRefImpl(
    ...
    override fun <D> transformChildren(transformer: AstTransformer<D>, data: D): AstComposedSuperTypeRefImpl {
        transformAnnotations(transformer, data)
        superTypeRefs.transformInplace(transformer, data)
        return this
    }

    override fun <D> transformAnnotations(transformer: AstTransformer<D>, data: D): AstComposedSuperTypeRefImpl {
