...
@OptIn(ExperimentalContracts::class)
inline fun buildResolvedFunctionTypeRefCopy(original: AstResolvedFunctionTypeRef, init: AstResolvedFunctionTypeRefBuilder.() -> Unit): AstResolvedFunctionTypeRef {
