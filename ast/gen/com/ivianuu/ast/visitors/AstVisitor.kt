...
abstract class AstVisitor<out R, in D> {
    ...
    open fun visitAnnotationContainer(annotationContainer: AstAnnotationContainer, data: D): R =
    ...
    open fun visitImport(import: AstImport, data: D): R = visitElement(import, data)

    open fun visitResolvedImport(resolvedImport: AstResolvedImport, data: D): R =
        visitElement(resolvedImport, data)

    open fun <E> visitSymbolOwner(
        symbolOwner: AstSymbolOwner<E>,
        data: D
    ): R where E : AstSymbolOwner<E>, E : AstDeclaration = visitElement(symbolOwner, data)

    open fun visitResolvable(resolvable: AstResolvable, data: D): R = visitElement(resolvable, data)

    open fun visitTargetElement(targetElement: AstTargetElement, data: D): R =
        visitElement(targetElement, data)

    open fun visitDeclarationStatus(declarationStatus: AstDeclarationStatus, data: D): R =
        visitElement(declarationStatus, data)

    open fun visitResolvedDeclarationStatus(
        resolvedDeclarationStatus: AstResolvedDeclarationStatus,
        data: D
    ): R = visitElement(resolvedDeclarationStatus, data)
    ...
    open fun visitDeclaration(declaration: AstDeclaration, data: D): R =
        visitElement(declaration, data)

    open fun visitAnnotatedDeclaration(annotatedDeclaration: AstAnnotatedDeclaration, data: D): R =
        visitElement(annotatedDeclaration, data)

    open fun visitAnonymousInitializer(anonymousInitializer: AstAnonymousInitializer, data: D): R =
        visitElement(anonymousInitializer, data)

    open fun visitTypedDeclaration(typedDeclaration: AstTypedDeclaration, data: D): R =
        visitElement(typedDeclaration, data)

    open fun <F : AstCallableDeclaration<F>> visitCallableDeclaration(
        callableDeclaration: AstCallableDeclaration<F>,
        data: D
    ): R = visitElement(callableDeclaration, data)

    open fun visitTypeParameterRef(typeParameterRef: AstTypeParameterRef, data: D): R =
        visitElement(typeParameterRef, data)

    open fun visitTypeParameter(typeParameter: AstTypeParameter, data: D): R =
        visitElement(typeParameter, data)

    open fun visitTypeParameterRefsOwner(
        typeParameterRefsOwner: AstTypeParameterRefsOwner,
        data: D
    ): R = visitElement(typeParameterRefsOwner, data)

    open fun visitTypeParametersOwner(typeParametersOwner: AstTypeParametersOwner, data: D): R =
        visitElement(typeParametersOwner, data)

    open fun visitMemberDeclaration(memberDeclaration: AstMemberDeclaration, data: D): R =
    ...
    open fun <F : AstCallableMemberDeclaration<F>> visitCallableMemberDeclaration(
        ...
        data: D
    ): R = visitElement(callableMemberDeclaration, data)

    open fun <F : AstVariable<F>> visitVariable(variable: AstVariable<F>, data: D): R =
        visitElement(variable, data)

    open fun visitValueParameter(valueParameter: AstValueParameter, data: D): R =
    ...
    open fun <F : AstClassLikeDeclaration<F>> visitClassLikeDeclaration(
        classLikeDeclaration: AstClassLikeDeclaration<F>,
        data: D
    ): R = visitElement(classLikeDeclaration, data)

    open fun <F : AstClass<F>> visitClass(klass: AstClass<F>, data: D): R =
        visitElement(klass, data)

    open fun visitRegularClass(regularClass: AstRegularClass, data: D): R =
        visitElement(regularClass, data)

    open fun visitTypeAlias(typeAlias: AstTypeAlias, data: D): R = visitElement(typeAlias, data)

    open fun <F : AstFunction<F>> visitFunction(function: AstFunction<F>, data: D): R =
        visitElement(function, data)

    open fun visitSimpleFunction(simpleFunction: AstSimpleFunction, data: D): R =
        visitElement(simpleFunction, data)

    open fun visitPropertyAccessor(propertyAccessor: AstPropertyAccessor, data: D): R =
        visitElement(propertyAccessor, data)

    open fun visitConstructor(constructor: AstConstructor, data: D): R =
        visitElement(constructor, data)

    open fun visitFile(file: AstFile, data: D): R = visitElement(file, data)

    open fun visitAnonymousFunction(anonymousFunction: AstAnonymousFunction, data: D): R =
        visitElement(anonymousFunction, data)

    open fun visitAnonymousObject(anonymousObject: AstAnonymousObject, data: D): R =
        visitElement(anonymousObject, data)

    open fun visitLoop(loop: AstLoop, data: D): R = visitElement(loop, data)

    open fun visitDoWhileLoop(doWhileLoop: AstDoWhileLoop, data: D): R =
    ...
    open fun visitBinaryLogicExpression(
        binaryLogicExpression: AstBinaryLogicExpression,
        data: D
    ): R = visitElement(binaryLogicExpression, data)

    open fun <E : AstTargetElement> visitJump(jump: AstJump<E>, data: D): R =
        visitElement(jump, data)

    open fun visitLoopJump(loopJump: AstLoopJump, data: D): R = visitElement(loopJump, data)

    open fun visitBreakExpression(breakExpression: AstBreakExpression, data: D): R =
        visitElement(breakExpression, data)

    open fun visitContinueExpression(continueExpression: AstContinueExpression, data: D): R =
        visitElement(continueExpression, data)

    open fun visitCatch(catch: AstCatch, data: D): R = visitElement(catch, data)

    open fun visitTryExpression(tryExpression: AstTryExpression, data: D): R =
        visitElement(tryExpression, data)

    open fun <T> visitConstExpression(constExpression: AstConstExpression<T>, data: D): R =
        visitElement(constExpression, data)

    open fun visitTypeProjection(typeProjection: AstTypeProjection, data: D): R =
        visitElement(typeProjection, data)

    open fun visitStarProjection(starProjection: AstStarProjection, data: D): R =
        visitElement(starProjection, data)

    open fun visitTypeProjectionWithVariance(
        typeProjectionWithVariance: AstTypeProjectionWithVariance,
        data: D
    ): R = visitElement(typeProjectionWithVariance, data)

    open fun visitArgumentList(argumentList: AstArgumentList, data: D): R =
        visitElement(argumentList, data)

    open fun visitCall(call: AstCall, data: D): R = visitElement(call, data)

    open fun visitAnnotationCall(annotationCall: AstAnnotationCall, data: D): R =
        visitElement(annotationCall, data)

    open fun visitComparisonExpression(comparisonExpression: AstComparisonExpression, data: D): R =
        visitElement(comparisonExpression, data)

    open fun visitTypeOperatorCall(typeOperatorCall: AstTypeOperatorCall, data: D): R =
        visitElement(typeOperatorCall, data)

    open fun visitAssignmentOperatorStatement(
        assignmentOperatorStatement: AstAssignmentOperatorStatement,
        data: D
    ): R = visitElement(assignmentOperatorStatement, data)

    open fun visitEqualityOperatorCall(equalityOperatorCall: AstEqualityOperatorCall, data: D): R =
        visitElement(equalityOperatorCall, data)

    open fun visitWhenExpression(whenExpression: AstWhenExpression, data: D): R =
        visitElement(whenExpression, data)

    open fun visitWhenBranch(whenBranch: AstWhenBranch, data: D): R = visitElement(whenBranch, data)

    open fun visitQualifiedAccess(qualifiedAccess: AstQualifiedAccess, data: D): R =
        visitElement(qualifiedAccess, data)

    open fun visitCheckNotNullCall(checkNotNullCall: AstCheckNotNullCall, data: D): R =
        visitElement(checkNotNullCall, data)

    open fun visitElvisExpression(elvisExpression: AstElvisExpression, data: D): R =
        visitElement(elvisExpression, data)

    open fun visitArrayOfCall(arrayOfCall: AstArrayOfCall, data: D): R =
        visitElement(arrayOfCall, data)

    open fun visitAugmentedArraySetCall(
        augmentedArraySetCall: AstAugmentedArraySetCall,
        data: D
    ): R = visitElement(augmentedArraySetCall, data)

    open fun visitClassReferenceExpression(
        classReferenceExpression: AstClassReferenceExpression,
        data: D
    ): R = visitElement(classReferenceExpression, data)

    open fun visitQualifiedAccessExpression(
        qualifiedAccessExpression: AstQualifiedAccessExpression,
        data: D
    ): R = visitElement(qualifiedAccessExpression, data)

    open fun visitFunctionCall(functionCall: AstFunctionCall, data: D): R =
        visitElement(functionCall, data)

    open fun visitDelegatedConstructorCall(
        delegatedConstructorCall: AstDelegatedConstructorCall,
        data: D
    ): R = visitElement(delegatedConstructorCall, data)

    open fun visitComponentCall(componentCall: AstComponentCall, data: D): R =
        visitElement(componentCall, data)

    open fun visitCallableReferenceAccess(
        callableReferenceAccess: AstCallableReferenceAccess,
        data: D
    ): R = visitElement(callableReferenceAccess, data)

    open fun visitThisReceiverExpression(
        thisReceiverExpression: AstThisReceiverExpression,
        data: D
    ): R = visitElement(thisReceiverExpression, data)

    open fun visitExpressionWithSmartcast(
        expressionWithSmartcast: AstExpressionWithSmartcast,
        data: D
    ): R = visitElement(expressionWithSmartcast, data)

    open fun visitSafeCallExpression(safeCallExpression: AstSafeCallExpression, data: D): R =
        visitElement(safeCallExpression, data)

    open fun visitCheckedSafeCallSubject(
        checkedSafeCallSubject: AstCheckedSafeCallSubject,
        data: D
    ): R = visitElement(checkedSafeCallSubject, data)

    open fun visitGetClassCall(getClassCall: AstGetClassCall, data: D): R =
        visitElement(getClassCall, data)

    open fun visitWrappedExpression(wrappedExpression: AstWrappedExpression, data: D): R =
        visitElement(wrappedExpression, data)

    open fun visitWrappedArgumentExpression(
        wrappedArgumentExpression: AstWrappedArgumentExpression,
        data: D
    ): R = visitElement(wrappedArgumentExpression, data)

    open fun visitLambdaArgumentExpression(
        lambdaArgumentExpression: AstLambdaArgumentExpression,
        data: D
    ): R = visitElement(lambdaArgumentExpression, data)

    open fun visitSpreadArgumentExpression(
        spreadArgumentExpression: AstSpreadArgumentExpression,
        data: D
    ): R = visitElement(spreadArgumentExpression, data)

    open fun visitNamedArgumentExpression(
        namedArgumentExpression: AstNamedArgumentExpression,
        data: D
    ): R = visitElement(namedArgumentExpression, data)

    open fun visitVarargArgumentsExpression(
        varargArgumentsExpression: AstVarargArgumentsExpression,
        data: D
    ): R = visitElement(varargArgumentsExpression, data)

    open fun visitResolvedQualifier(resolvedQualifier: AstResolvedQualifier, data: D): R =
        visitElement(resolvedQualifier, data)

    open fun visitResolvedReifiedParameterReference(
        resolvedReifiedParameterReference: AstResolvedReifiedParameterReference,
        data: D
    ): R = visitElement(resolvedReifiedParameterReference, data)

    open fun visitReturnExpression(returnExpression: AstReturnExpression, data: D): R =
    ...
    open fun visitStringConcatenationCall(
        ...
        data: D
    ): R = visitElement(stringConcatenationCall, data)

    open fun visitThrowExpression(throwExpression: AstThrowExpression, data: D): R =
        visitElement(throwExpression, data)

    open fun visitVariableAssignment(variableAssignment: AstVariableAssignment, data: D): R =
        visitElement(variableAssignment, data)

    open fun visitWhenSubjectExpression(
        whenSubjectExpression: AstWhenSubjectExpression,
        data: D
    ): R = visitElement(whenSubjectExpression, data)

    open fun visitWrappedDelegateExpression(
        wrappedDelegateExpression: AstWrappedDelegateExpression,
        data: D
    ): R = visitElement(wrappedDelegateExpression, data)

    open fun visitNamedReference(namedReference: AstNamedReference, data: D): R =
        visitElement(namedReference, data)

    open fun visitSuperReference(superReference: AstSuperReference, data: D): R =
        visitElement(superReference, data)

    open fun visitThisReference(thisReference: AstThisReference, data: D): R =
        visitElement(thisReference, data)

    open fun visitResolvedNamedReference(
        resolvedNamedReference: AstResolvedNamedReference,
        data: D
    ): R = visitElement(resolvedNamedReference, data)

    open fun visitDelegateFieldReference(
        delegateFieldReference: AstDelegateFieldReference,
        data: D
    ): R = visitElement(delegateFieldReference, data)

    open fun visitBackingFieldReference(
        backingFieldReference: AstBackingFieldReference,
        data: D
    ): R = visitElement(backingFieldReference, data)

    open fun visitResolvedCallableReference(
        resolvedCallableReference: AstResolvedCallableReference,
        data: D
    ): R = visitElement(resolvedCallableReference, data)

    open fun visitResolvedTypeRef(resolvedTypeRef: AstResolvedTypeRef, data: D): R =
        visitElement(resolvedTypeRef, data)

    open fun visitTypeRefWithNullability(
        typeRefWithNullability: AstTypeRefWithNullability,
        data: D
    ): R = visitElement(typeRefWithNullability, data)

    open fun visitUserTypeRef(userTypeRef: AstUserTypeRef, data: D): R =
        visitElement(userTypeRef, data)

    open fun visitDynamicTypeRef(dynamicTypeRef: AstDynamicTypeRef, data: D): R =
        visitElement(dynamicTypeRef, data)

    open fun visitFunctionTypeRef(functionTypeRef: AstFunctionTypeRef, data: D): R =
        visitElement(functionTypeRef, data)

    open fun visitResolvedFunctionTypeRef(
        resolvedFunctionTypeRef: AstResolvedFunctionTypeRef,
        data: D
    ): R = visitElement(resolvedFunctionTypeRef, data)

    open fun visitImplicitTypeRef(implicitTypeRef: AstImplicitTypeRef, data: D): R =
        visitElement(implicitTypeRef, data)

    open fun visitComposedSuperTypeRef(composedSuperTypeRef: AstComposedSuperTypeRef, data: D): R =
        visitElement(composedSuperTypeRef, data)
