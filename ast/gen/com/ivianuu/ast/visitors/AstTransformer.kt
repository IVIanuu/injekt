...
abstract class AstTransformer<in D> : AstVisitor<CompositeTransformResult<AstElement>, D>() {
    ...
    open fun transformAnnotationContainer(
        annotationContainer: AstAnnotationContainer,
        data: D
    ): CompositeTransformResult<AstAnnotationContainer> {
    ...
    open fun transformReference(
        reference: AstReference,
        data: D
    ): CompositeTransformResult<AstReference> {
    ...
    open fun transformImport(import: AstImport, data: D): CompositeTransformResult<AstImport> {
        return transformElement(import, data)
    }

    open fun transformResolvedImport(
        resolvedImport: AstResolvedImport,
        data: D
    ): CompositeTransformResult<AstImport> {
        return transformElement(resolvedImport, data)
    }

    open fun <E> transformSymbolOwner(
        symbolOwner: AstSymbolOwner<E>,
        data: D
    ): CompositeTransformResult<AstSymbolOwner<E>> where E : AstSymbolOwner<E>, E : AstDeclaration {
        return transformElement(symbolOwner, data)
    }

    open fun transformResolvable(
        resolvable: AstResolvable,
        data: D
    ): CompositeTransformResult<AstResolvable> {
        return transformElement(resolvable, data)
    }

    open fun transformTargetElement(
        targetElement: AstTargetElement,
        data: D
    ): CompositeTransformResult<AstTargetElement> {
        return transformElement(targetElement, data)
    }

    open fun transformDeclarationStatus(
        declarationStatus: AstDeclarationStatus,
        data: D
    ): CompositeTransformResult<AstDeclarationStatus> {
        return transformElement(declarationStatus, data)
    }

    open fun transformResolvedDeclarationStatus(
    ...
    open fun transformDeclaration(
        declaration: AstDeclaration,
        data: D
    ): CompositeTransformResult<AstDeclaration> {
        return transformElement(declaration, data)
    }

    open fun transformAnnotatedDeclaration(
    ...
    open fun transformTypedDeclaration(
    ...
    open fun <F : AstCallableDeclaration<F>> transformCallableDeclaration(
    ...
    open fun transformTypeParameterRef(
        typeParameterRef: AstTypeParameterRef,
        data: D
    ): CompositeTransformResult<AstTypeParameterRef> {
        return transformElement(typeParameterRef, data)
    }

    open fun transformTypeParameter(
    ...
    open fun transformTypeParameterRefsOwner(
        typeParameterRefsOwner: AstTypeParameterRefsOwner,
        data: D
    ): CompositeTransformResult<AstTypeParameterRefsOwner> {
        return transformElement(typeParameterRefsOwner, data)
    }

    open fun transformTypeParametersOwner(
        typeParametersOwner: AstTypeParametersOwner,
        data: D
    ): CompositeTransformResult<AstTypeParametersOwner> {
        return transformElement(typeParametersOwner, data)
    }

    open fun transformMemberDeclaration(
    ...
    open fun <F : AstCallableMemberDeclaration<F>> transformCallableMemberDeclaration(
    ...
    open fun <F : AstVariable<F>> transformVariable(
    ...
    open fun transformValueParameter(
    ...
    open fun transformEnumEntry(
        enumEntry: AstEnumEntry,
        data: D
    ): CompositeTransformResult<AstDeclaration> {
        return transformElement(enumEntry, data)
    }

    open fun <F : AstClassLikeDeclaration<F>> transformClassLikeDeclaration(
    ...
    open fun <F : AstClass<F>> transformClass(
        klass: AstClass<F>,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    open fun transformRegularClass(
        regularClass: AstRegularClass,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(regularClass, data)
    }

    open fun transformTypeAlias(
    ...
    open fun <F : AstFunction<F>> transformFunction(
    ...
    open fun transformSimpleFunction(
    ...
    open fun transformPropertyAccessor(
    ...
    open fun transformAnonymousFunction(
    ...
    open fun transformAnonymousObject(
        anonymousObject: AstAnonymousObject,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    open fun transformDoWhileLoop(
        doWhileLoop: AstDoWhileLoop,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(doWhileLoop, data)
    }

    open fun transformWhileLoop(
    ...
    open fun transformBinaryLogicExpression(
    ...
    open fun <E : AstTargetElement> transformJump(
        jump: AstJump<E>,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    open fun transformLoopJump(
        loopJump: AstLoopJump,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(loopJump, data)
    }

    open fun transformBreakExpression(
    ...
    open fun transformContinueExpression(
    ...
    open fun transformTryExpression(
        tryExpression: AstTryExpression,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(tryExpression, data)
    }

    open fun <T> transformConstExpression(
    ...
    open fun transformTypeProjection(
        typeProjection: AstTypeProjection,
        data: D
    ): CompositeTransformResult<AstTypeProjection> {
        return transformElement(typeProjection, data)
    }

    open fun transformStarProjection(
        starProjection: AstStarProjection,
        data: D
    ): CompositeTransformResult<AstTypeProjection> {
        return transformElement(starProjection, data)
    }

    open fun transformTypeProjectionWithVariance(
    ...
    open fun transformArgumentList(
        argumentList: AstArgumentList,
        data: D
    ): CompositeTransformResult<AstArgumentList> {
    ...
    open fun transformAnnotationCall(
        annotationCall: AstAnnotationCall,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(annotationCall, data)
    }

    open fun transformComparisonExpression(
    ...
    open fun transformTypeOperatorCall(
    ...
    open fun transformAssignmentOperatorStatement(
    ...
    open fun transformEqualityOperatorCall(
    ...
    open fun transformWhenExpression(
        whenExpression: AstWhenExpression,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(whenExpression, data)
    }

    open fun transformWhenBranch(
        whenBranch: AstWhenBranch,
        data: D
    ): CompositeTransformResult<AstWhenBranch> {
        return transformElement(whenBranch, data)
    }

    open fun transformQualifiedAccess(
    ...
    open fun transformCheckNotNullCall(
    ...
    open fun transformElvisExpression(
        elvisExpression: AstElvisExpression,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(elvisExpression, data)
    }

    open fun transformArrayOfCall(
        arrayOfCall: AstArrayOfCall,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(arrayOfCall, data)
    }

    open fun transformAugmentedArraySetCall(
    ...
    open fun transformClassReferenceExpression(
    ...
    open fun transformQualifiedAccessExpression(
    ...
    open fun transformFunctionCall(
    ...
    open fun transformDelegatedConstructorCall(
    ...
    open fun transformComponentCall(
    ...
    open fun transformCallableReferenceAccess(
    ...
    open fun transformThisReceiverExpression(
    ...
    open fun transformExpressionWithSmartcast(
    ...
    open fun transformSafeCallExpression(
    ...
    open fun transformCheckedSafeCallSubject(
    ...
    open fun transformGetClassCall(
        getClassCall: AstGetClassCall,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(getClassCall, data)
    }

    open fun transformWrappedExpression(
    ...
    open fun transformWrappedArgumentExpression(
    ...
    open fun transformLambdaArgumentExpression(
    ...
    open fun transformSpreadArgumentExpression(
    ...
    open fun transformNamedArgumentExpression(
    ...
    open fun transformVarargArgumentsExpression(
    ...
    open fun transformResolvedQualifier(
    ...
    open fun transformResolvedReifiedParameterReference(
    ...
    open fun transformReturnExpression(
    ...
    open fun transformStringConcatenationCall(
    ...
    open fun transformThrowExpression(
        throwExpression: AstThrowExpression,
        data: D
    ): CompositeTransformResult<AstStatement> {
        return transformElement(throwExpression, data)
    }

    open fun transformVariableAssignment(
    ...
    open fun transformWhenSubjectExpression(
    ...
    open fun transformWrappedDelegateExpression(
    ...
    open fun transformNamedReference(
        namedReference: AstNamedReference,
        data: D
    ): CompositeTransformResult<AstReference> {
        return transformElement(namedReference, data)
    }

    open fun transformSuperReference(
        superReference: AstSuperReference,
        data: D
    ): CompositeTransformResult<AstReference> {
        return transformElement(superReference, data)
    }

    open fun transformThisReference(
        thisReference: AstThisReference,
        data: D
    ): CompositeTransformResult<AstReference> {
        return transformElement(thisReference, data)
    }

    open fun transformResolvedNamedReference(
    ...
    open fun transformDelegateFieldReference(
    ...
    open fun transformBackingFieldReference(
    ...
    open fun transformResolvedCallableReference(
    ...
    open fun transformResolvedTypeRef(
    ...
    open fun transformTypeRefWithNullability(
    ...
    open fun transformDynamicTypeRef(
    ...
    open fun transformFunctionTypeRef(
    ...
    open fun transformImplicitTypeRef(
    ...
    open fun transformComposedSuperTypeRef(
    ...
    final override fun visitElement(
        element: AstElement,
        data: D
    ): CompositeTransformResult<AstElement> {
    ...
    final override fun visitTypeRef(
        typeRef: AstTypeRef,
        data: D
    ): CompositeTransformResult<AstTypeRef> {
    ...
    final override fun visitReference(
        reference: AstReference,
        data: D
    ): CompositeTransformResult<AstReference> {
    ...
    final override fun visitImport(
        import: AstImport,
        data: D
    ): CompositeTransformResult<AstImport> {
    ...
    final override fun visitResolvedImport(
        resolvedImport: AstResolvedImport,
        data: D
    ): CompositeTransformResult<AstImport> {
    ...
    final override fun visitResolvable(
        resolvable: AstResolvable,
        data: D
    ): CompositeTransformResult<AstResolvable> {
    ...
    final override fun visitStatement(
        statement: AstStatement,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitExpression(
        expression: AstExpression,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitTypeParameter(
        typeParameter: AstTypeParameter,
        data: D
    ): CompositeTransformResult<AstDeclaration> {
    ...
    final override fun visitValueParameter(
        valueParameter: AstValueParameter,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitProperty(
        property: AstProperty,
        data: D
    ): CompositeTransformResult<AstDeclaration> {
    ...
    final override fun visitEnumEntry(
        enumEntry: AstEnumEntry,
        data: D
    ): CompositeTransformResult<AstDeclaration> {
    ...
    final override fun <F : AstClass<F>> visitClass(
        klass: AstClass<F>,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitRegularClass(
        regularClass: AstRegularClass,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitTypeAlias(
        typeAlias: AstTypeAlias,
        data: D
    ): CompositeTransformResult<AstDeclaration> {
    ...
    final override fun visitSimpleFunction(
        simpleFunction: AstSimpleFunction,
        data: D
    ): CompositeTransformResult<AstDeclaration> {
    ...
    final override fun visitAnonymousObject(
        anonymousObject: AstAnonymousObject,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitDoWhileLoop(
        doWhileLoop: AstDoWhileLoop,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitWhileLoop(
        whileLoop: AstWhileLoop,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun <E : AstTargetElement> visitJump(
        jump: AstJump<E>,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitLoopJump(
        loopJump: AstLoopJump,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitBreakExpression(
        breakExpression: AstBreakExpression,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitTryExpression(
        tryExpression: AstTryExpression,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitTypeProjection(
        typeProjection: AstTypeProjection,
        data: D
    ): CompositeTransformResult<AstTypeProjection> {
    ...
    final override fun visitStarProjection(
        starProjection: AstStarProjection,
        data: D
    ): CompositeTransformResult<AstTypeProjection> {
    ...
    final override fun visitArgumentList(
        argumentList: AstArgumentList,
        data: D
    ): CompositeTransformResult<AstArgumentList> {
    ...
    final override fun visitAnnotationCall(
        annotationCall: AstAnnotationCall,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitWhenExpression(
        whenExpression: AstWhenExpression,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitWhenBranch(
        whenBranch: AstWhenBranch,
        data: D
    ): CompositeTransformResult<AstWhenBranch> {
    ...
    final override fun visitQualifiedAccess(
        qualifiedAccess: AstQualifiedAccess,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitElvisExpression(
        elvisExpression: AstElvisExpression,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitArrayOfCall(
        arrayOfCall: AstArrayOfCall,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitFunctionCall(
        functionCall: AstFunctionCall,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitComponentCall(
        componentCall: AstComponentCall,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitGetClassCall(
        getClassCall: AstGetClassCall,
        data: D
    ): CompositeTransformResult<AstStatement> {
    ...
    final override fun visitNamedReference(
        namedReference: AstNamedReference,
        data: D
    ): CompositeTransformResult<AstReference> {
    ...
    final override fun visitSuperReference(
        superReference: AstSuperReference,
        data: D
    ): CompositeTransformResult<AstReference> {
    ...
    final override fun visitThisReference(
        thisReference: AstThisReference,
        data: D
    ): CompositeTransformResult<AstReference> {
    ...
    final override fun visitResolvedTypeRef(
        resolvedTypeRef: AstResolvedTypeRef,
        data: D
    ): CompositeTransformResult<AstTypeRef> {
    ...
    final override fun visitUserTypeRef(
        userTypeRef: AstUserTypeRef,
        data: D
    ): CompositeTransformResult<AstTypeRef> {
    ...
    final override fun visitDynamicTypeRef(
        dynamicTypeRef: AstDynamicTypeRef,
        data: D
    ): CompositeTransformResult<AstTypeRef> {
    ...
    final override fun visitFunctionTypeRef(
        functionTypeRef: AstFunctionTypeRef,
        data: D
    ): CompositeTransformResult<AstTypeRef> {
    ...
    final override fun visitImplicitTypeRef(
        implicitTypeRef: AstImplicitTypeRef,
        data: D
    ): CompositeTransformResult<AstTypeRef> {
