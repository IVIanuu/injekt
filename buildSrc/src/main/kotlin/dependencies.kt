...
object Deps {
  ...
  const val atomicFuGradlePlugin = "org.jetbrains.kotlinx:atomicfu-gradle-plugin:0.19.0"
  ...
  const val mavenPublishGradlePlugin = "com.vanniktech:gradle-maven-publish-plugin:0.23.2"
