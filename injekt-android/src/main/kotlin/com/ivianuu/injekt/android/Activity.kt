...
@TypeBinding
inline val ComponentActivity.ActivityContext: Context
    get() = this

@TypeBinding
inline val ComponentActivity.ActivityResources: Resources
    get() = resources

@TypeBinding
inline val ComponentActivity.ActivityLifecycleOwner: LifecycleOwner
    get() = this

@TypeBinding
inline val ComponentActivity.ActivityOnBackPressedDispatcherOwner: OnBackPressedDispatcherOwner
    get() = this

@TypeBinding
inline val ComponentActivity.ActivitySavedStateRegistryOwner: SavedStateRegistryOwner
    get() = this

@TypeBinding
inline val ComponentActivity.ActivityViewModelStoreOwner: ViewModelStoreOwner
    get() = this
