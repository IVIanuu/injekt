...
/**
 * Calls the specified function [block] and returns it's result with [a] and [b] as given
 */
...
/**
 * Calls the specified function [block] and returns it's result with [a], [b] and [c] as given
 */
...
/**
 * Calls the specified function [block] and returns it's result with [a], [b], [c] and [d] as given
 */
...
/**
 * Calls the specified function [block] and returns it's result with [a], [b], [c], [d] and [e] as given
 */
