...
private class ElementMapping(elements: Collection<KindOwner>) {
    private val varToElements: Map<Int, KindOwner> =
    ...
    private val elementsToVar: Map<KindOwner, Int> =
...
private fun solve2sat(
    elements: Collection<KindOwner>,
    elementsToVar: ElementMapping
): MutableList<Boolean> {
