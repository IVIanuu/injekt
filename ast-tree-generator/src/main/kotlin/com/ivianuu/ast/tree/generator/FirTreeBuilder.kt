...
import com.ivianuu.ast.tree.generator.model.Element.Kind.Diagnostics
...
object FirTreeBuilder : AbstractFirTreeBuilder() {
    ...
    val anonymousObject =
        element("AnonymousObject", Declaration, klass, controlFlowGraphOwner, expression)
    ...
    val errorFunction =
        element("ErrorFunction", Declaration, function, diagnosticHolder, typeParametersOwner)
    val errorProperty =
        element("ErrorProperty", Declaration, variable, diagnosticHolder, typeParametersOwner)
    ...
    val errorResolvedQualifier =
        element("ErrorResolvedQualifier", Expression, resolvedQualifier, diagnosticHolder)
    ...
    val errorNamedReference =
        element("ErrorNamedReference", Reference, namedReference, diagnosticHolder)
