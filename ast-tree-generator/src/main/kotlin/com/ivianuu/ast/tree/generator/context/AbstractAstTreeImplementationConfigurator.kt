...
abstract class AbstractAstTreeImplementationConfigurator {
    ...
    protected fun generateDefaultImplementations(builder: AbstractAstTreeBuilder) {
    ...
    private fun collectLeafsWithoutImplementation(builder: AbstractAstTreeBuilder): Set<Element> {
    ...
    inner class ImplementationContext(private val implementation: Implementation) {
        ...
        fun Implementation.withArg(argument: Importable): ImplementationWithArg =
            ImplementationWithArg(this, argument)
            ...
            fun applyConfiguration() {
                ...
                when {
                    ...
                    delegate != null -> {
                        ...
                        field.defaultValueInImplementation =
                            "${actualDelegateField.name}${actualDelegateField.call()}$name"
                    }
                }
            }
        }
