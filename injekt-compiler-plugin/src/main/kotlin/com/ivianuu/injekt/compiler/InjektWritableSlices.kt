...
import com.ivianuu.injekt.compiler.resolution.ProvidersWithLookups
...
object InjektWritableSlices {
  ...
  val CONSTRUCTOR_PROVIDERS = BasicWritableSlice<ClassDescriptor, List<CallableRef>>(RewritePolicy.DO_NOTHING)
  val IS_PROVIDE = BasicWritableSlice<Any, Boolean>(RewritePolicy.DO_NOTHING)
  val IS_CONTEXT = BasicWritableSlice<Any, Boolean>(RewritePolicy.DO_NOTHING)
  val BLOCK_SCOPE = BasicWritableSlice<Pair<KtBlockExpression, DeclarationDescriptor>, ContextScope>(RewritePolicy.DO_NOTHING)
  ...
  val ELEMENT_SCOPE = BasicWritableSlice<KtElement, ContextScope>(RewritePolicy.DO_NOTHING)
  val DECLARATION_SCOPE = BasicWritableSlice<DescriptorWithParentScope, ContextScope>(RewritePolicy.DO_NOTHING)
  val TYPE_SCOPE_PROVIDERS = BasicWritableSlice<TypeRefKey, ProvidersWithLookups>(RewritePolicy.DO_NOTHING)
  val TYPE_PROVIDERS = BasicWritableSlice<Pair<TypeRef, Boolean>, List<CallableRef>>(RewritePolicy.DO_NOTHING)
  val PACKAGE_TYPE_SCOPE_PROVIDERS = BasicWritableSlice<FqName, List<CallableRef>>(RewritePolicy.DO_NOTHING)
  ...
  val LOOKUPS = BasicWritableSlice<String, MutableMap<LookupLocation, MutableSet<String>>>(RewritePolicy.DO_NOTHING)
