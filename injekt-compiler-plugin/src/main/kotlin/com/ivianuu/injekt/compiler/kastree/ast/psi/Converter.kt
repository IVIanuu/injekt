package com.ivianuu.injekt.compiler.kastree.ast.psi

import com.ivianuu.injekt.compiler.kastree.ast.Node
...
open class Converter {
  ...
  open fun convertStmtNo(v: KtExpression) =
    if (v is KtDeclaration) Node.Stmt.Decl(convertDecl(v))
      .map(v) else Node.Stmt.Expr(convertExpr(v)).map(v)
